...
| `.claude-plugin/` | Generated by the registry from the listing itself. An author's copy would shadow it and describe the plugin as something other than what the catalogue shows. |
